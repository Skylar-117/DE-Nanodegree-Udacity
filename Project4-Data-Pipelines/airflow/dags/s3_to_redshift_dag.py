...
schema_created_operator = DummyOperator(task_id='Schema_created', dag=dag)
...
stage_events_to_redshift = StageToRedshiftOperator(
    ...
    s3_bucket="udacity-airflow",
    s3_prefix="log_data",
    json="s3://udacity-airflow/log_json_path.json"
)
...
# Task Dependencies
start_operator >> [create_staging_events_table, create_staging_songs_table, create_songplays_table, create_artists_table, create_songs_table, create_users_table, create_time_table] >> schema_created_operator

schema_created_operator >> [stage_songs_to_redshift, stage_events_to_redshift] >> load_songplays_table
